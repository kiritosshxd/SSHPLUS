...
#	@kiritosshxd
#====================================================
_lvk=$(wget -qO- https://raw.githubusercontent.com/kiritosshxd/SSHPLUS/master/Sistema/versao)
...
[[ -e "/bin/initbot" ]] && {
    ...
    cd $HOME
    wget https://www.dropbox.com/s/q9yk482k7564ep6/initbot -o /dev/null
    mv -f $HOME/initbot /bin/initbot
    chmod 777 /bin/initbot
}
[[ -e "/bin/badvpn" ]] && {
    sleep 0.1
} || {
    cd $HOME
    wget https://www.dropbox.com/s/r41xef6w94iv59s/badvpn -o /dev/null
    mv -f $HOME/badvpn /bin/badvpn
...
#INICIO AUTOMATICO' >/etc/autostart
    ...
    [[ $(ps x | grep "bot_plus" | grep -v grep | wc -l) != '0' ]] && wget -qO- https://www.dropbox.com/s/7dkgxy00x33c4y7/ShellBot.sh
...
wget https://github.com/kiritosshxd/SSHPLUS/raw/main/Install/jq-linuxaarch64 >/dev/null 2>&1
chmod +x jq-linuxaarch64 && mv jq-linuxaarch64 $(which jq)
